...
| <a name="input_lambda_binary_base64sha256_url"></a> [lambda\_binary\_base64sha256\_url](#input\_lambda\_binary\_base64sha256\_url) | Optional URL returning the base64-encoded SHA256 for lambda\_binary\_url. Defaults to appending .base64sha256 to lambda\_binary\_url. | `string` | `null` | no |
...
| <a name="input_lambda_binary_url"></a> [lambda\_binary\_url](#input\_lambda\_binary\_url) | URL to the pre-compiled Go Lambda zip. Used when lambda\_binary\_path is null and build\_lambda\_locally is false. | `string` | `"https://github.com/MachineDotDev/nat-zero/releases/download/nat-zero-lambda-latest/lambda.zip"` | no |
